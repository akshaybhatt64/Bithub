         ...
         <?php include('errors.php'); ?>
          <div class="upper text-center">
           ...
           <div class="input-group mb-3">
              ...
              <input type="text" class="form-control span-body" placeholder="First Name" name="firstName" value="<?php echo $firstName; ?>">
              <input type="text" class="form-control span-body" placeholder="Last Name" name="lastName" value="<?php echo $lastName; ?>">
            </div>  
         <div class="input-group mb-3">
              <input type="text" class="form-control span-body" placeholder="Your Email" id="mail" name="email" value="<?php echo $email; ?>">
